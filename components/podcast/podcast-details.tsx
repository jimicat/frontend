...
export function PodcastDetails({ podcastId }: { podcastId: string }) {
  ...
  console.log("podcast格式", podcast);
  console.log("episodes格式", episodes);
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-start">
          <div className="relative aspect-square w-full max-w-[240px] overflow-hidden rounded-lg">
            <Image
              src={podcast.image || "/placeholder.svg?height=240&width=240"}
              alt={podcast.title}
              fill
            ...
            <div>
              <div className="flex items-center gap-2">
                {Object.entries(podcast.categories).map(([id, name]) => (
                  <Badge key={id} className="bg-purple-600 hover:bg-purple-700">
                    {name}
                  </Badge>
                ))}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-1 flex items-center gap-2 text-xs text-muted-foreground">
                            ...
                            <span className="flex items-center gap-1">
                              ...
                              {formatDate(episode.datePublishedPretty)}
                            </span>
                          </div>
                        ...
                        <div className="flex shrink-0 gap-2">
                          <Button
                            ...
                            onClick={() => {
                              ...
                              // 如果点击的是当前播放的集数，则切换播放状态
                              if (selectedEpisode === episode.id) {
                                setIsPlaying(!isPlaying);
                              } else {
                                // 如果点击的是新的集数，设置新的集数并开始播放
